...
while True:
    ...
    sidebar[:] = (0, 0, 0)  # Black background for sidebar
    ...
    if results.multi_hand_landmarks:
        for hand_landmarks in results.multi_hand_landmarks:
            ...
            # Display the distance on the sidebar
            cv2.putText(sidebar, f"Gesture Distance:", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
            cv2.putText(sidebar, f"{distance:.2f} px", (10, 70), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
    ...
    cv2.imshow("Hand Gesture Control with Distance", frame_with_sidebar)
