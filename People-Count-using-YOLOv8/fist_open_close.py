...
def is_fist_closed(hand_landmarks):
    ...
    # We will check the distance between specific finger landmarks
    # Finger landmarks are: 8, 12, 16, 20 (tips of fingers)
    # If the distance between these tips and base points are small, it indicates the fist is closed
    
    # We will check the tip of the thumb (4), index (8), middle (12), ring (16), and pinky (20)
    distances = []
    
    # Calculate distances between thumb (4) and other fingers
...
while True:
    ...
    if results.multi_hand_landmarks:
        ...
        if is_fist_closed(hand_landmarks):
            # Display "Fan OFF" at the top and instructions at the bottom center
            ...
            # Display "Fan ON" at the top and instructions at the bottom center
