...
# Define a virtual on-screen keyboard (this can be expanded or customized)
keyboard_layout = [
    ['Q', 'W', 'E', 'R', 'T', 'Y', 'U', 'I', 'O', 'P'],
    ['A', 'S', 'D', 'F', 'G', 'H', 'J', 'K', 'L'],
    ['Z', 'X', 'C', 'V', 'B', 'N', 'M'],
...
key_width = 100
key_height = 100
keyboard_x = 100  # X position of the keyboard
keyboard_y = 400  # Y position of the keyboard
...
# Function to draw keyboard on the screen
def draw_keyboard(frame):
    for row_idx, row in enumerate(keyboard_layout):
        for col_idx, key in enumerate(row):
            ...
            cv2.putText(frame, key, (x1 + 30, y1 + 60), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
